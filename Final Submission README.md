...
Project Description
This project applies Bayesian statistical modeling to a comprehensive shot-by-shot NBA dataset spanning 2000–2024. The goal is to move beyond raw field goal percentages and use principled probabilistic methods to understand shooting efficiency across distance, court zone, player, era, and game situation.
...
Coverage: Shot-by-shot records from the 2000–01 season through 2024
