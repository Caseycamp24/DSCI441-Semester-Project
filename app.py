# -*- coding: utf-8 -*-
"""
Created on Mon Apr 27 20:32:33 2026
...
DATA_PATH = st.sidebar.text_input(
    "Data folder path",
    value=r"C:\Users\casey\.cache\kagglehub\datasets\techbaron13\nba-shots-dataset-2001-present\versions\2\nba",
    help="Path to the folder containing the NBA CSV files.",
)
...
full_df, csv_files = load_data(DATA_PATH)
